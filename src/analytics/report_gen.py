...
class TeacherAnalyst:
    ...
    def generate_class_report(self):
        ...
        return reports
    def get_individual_advice(self, student_name, precision, lifts):
        """Generates specific advice for one kid based on ML features"""
        
        if lifts > 5:
           return {
                "RW": "Uyu mwana akunda kuzamura ikaramu kenshi. Mugufashe gukomeza ku rupapuro.",
                "EN": "This child lifts the pen too often. Encourage them to stay on the screen.",
                "FR": "Cet enfant lève trop souvent le stylo. Encouragez-le à rester sur l'écran."
            }
        return {"RW": "Arigukora neza!", "EN": "Doing great!", "FR": "Continuez comme ça!"}
